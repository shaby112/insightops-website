import { AreaChart, BarChart, LineChart, DonutChart, SparkAreaChart, ProgressBar } from "@tremor/react";
...
export function WidgetChart({ config, className, isEditMode = false, onUpdate }: WidgetChartProps) {
  ...
  // Tremor chart common props with dark mode support
  const chartProps = {
    data,
    index: indexField,
    categories,
  ...
  switch (chartType) {
    case "area":
      return <AreaChart {...chartProps} curveType="natural" />;
    case "bar":
      return <BarChart {...chartProps} />;
    case "line":
      return <LineChart {...chartProps} curveType="natural" />;
    case "donut":
      return <DonutChart {...donutProps} />;
    ...
    case "progress":
      ...
      return (
        <div className={cn("h-full flex flex-col justify-center p-4", className)}>
          ...
          <ProgressBar value={progressPercent} color="rose" className="mt-2" />
    ...
    case "gauge":
      ...
      const rotation = -90 + (gaugePercent / 100) * 180;
      return (
        <div className={cn("h-full flex flex-col items-center justify-center p-4", className)}>
          <div className="relative w-32 h-16 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-center">
              <span className="text-xl font-bold text-foreground">{gaugePercent.toFixed(0)}%</span>
            </div>
          </div>
